			...
			<div class="card shadow">
				<div class="card-body">
					...
					<div class="table-responsive">
						<?php
							$conn = mysqli_init();
							mysqli_real_connect($conn, 'ihost.it.kmitl.ac.th', 'it63070056_berg', 'Natapon45', 'it63070056_db', 3306);
						...
						<table class="table table-bordorless table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="delete.php?ID=<?php echo $Result['ID'];?>" class="btn btn-danger mb-2 mb-md-0">ลบ</a> <a href="edit.php?ID=<?php echo $Result['ID'];?>" class="btn btn-success">แก้ไข</a></td>
								</tr>
								<?php
									}
								?>
